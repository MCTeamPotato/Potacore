...
public class PotatoEntityData extends SavedData {
    private final Map<UUID, Map<String, Object>> entityData = new Object2ObjectOpenHashMap<>();
    ...
    private void loadData(@NotNull CompoundTag tag) {
        ...
        for (String uuidStr : tag.getAllKeys()) {
            try {
                ...
                Map<String, Object> dataMap = new Object2ObjectOpenHashMap<>();
    ...
    public void setData(@NotNull UUID entity, @NotNull String key, @NotNull Object value) {
        entityData.computeIfAbsent(entity, u -> new Object2ObjectOpenHashMap<>()).put(key, value);
        setDirty();
    }

    public void setDataMap(@NotNull UUID entity, @NotNull Map<String, Object> dataMap) {
        entityData.put(entity, new Object2ObjectOpenHashMap<>(dataMap));
        setDirty();
    }
    ...
    public @NotNull Map<String, Object> getDataMap(@NotNull UUID uuid) {
        return entityData.computeIfAbsent(uuid, u -> new Object2ObjectOpenHashMap<>());
    }
